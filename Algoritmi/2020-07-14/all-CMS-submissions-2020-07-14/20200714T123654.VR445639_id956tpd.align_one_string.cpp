...
* score: 0.0
* date:  2020-07-14 12:36:54.130772
*/
#include <iostream>
#include <cstdio>
#include <string>
...
bool is_comp(int b1, int a1){ // predicato di compatibilità
    ...
    bool c1_in_sigma = (b1 >= 'A') && (b1 <= 'Z');
    bool c2_in_sigma = (a1 >= 'A') && (a1 <= 'Z');
...
// Partendo da b, non è stato possibile ottenere un b'
