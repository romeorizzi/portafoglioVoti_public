...
* task:  risparmio
* score: 100.0
* date:  2020-07-14 12:49:17.654995
*/
#include <iostream>
...
int combine(int a, int b, int tm, int tm1) {
    ...
    if (A[tm] == A[tm1] && a != 0 && b != 0 && A[tm] != 0) {
        // intervalli contigui e tali che venga contato almeno un intervallo nell'intervallo di ricerca
        return 1 + (a-1) + (b-1);
    }
    return a+b;
}
