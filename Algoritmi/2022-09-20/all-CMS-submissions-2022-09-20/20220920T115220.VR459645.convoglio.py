...
* score: 0.0
* date:  2022-09-20 11:52:20.393167
"""
#!/usr/bin/env python3
...
def attacco(mat_input, mat_ris, N, M, i):
    ...
    if(mat_ris[nave_attaccante][0]==None and mat_navi_attaccate[nave_attaccata]==None):
        ...
        mat_navi_attaccate[nave_attaccata]=nave_attaccante
...
mat_turing=[[None for _ in range(2)]for _ in range (n)]
mat_navi_attaccate=[None for _ in range (n)]
...
a=attacco(mat_input, mat_ris, n, m, 0)
if (a==-1):
    print(-1)