...
* task:  A_seq
* score: 0.0
* date:  2022-06-29 11:20:58.283696
"""
elems = []
def a_seq(index, upper, lower, count_up, count_low):
    ...
    if index+2 != len(elems)-1:
        ...
        s2 = a_seq(index+1, elems[index+2], elem, 0 if elem == elems[index+2] else 1, 1)
...
if __name__=="__main__":
    ...
    with open("output.txt", "w") as out:
        out.write("{}".format(a_seq(1,elems[1],elems[0],0 if elems[0] == elems[1] else 1,1)))
