...
* score: 58.0
* date:  2022-06-29 12:20:14.166824
"""
import sys
...
def num_sequences(n, first_val =0):
    ...
    if (n,first_val) not in MEMO_num_seq:
        MEMO_num_seq[(n,first_val)] = num_sequences(n-1,first_val) + num_sequences(n-1,first_val-1) + num_sequences(n-1,first_val +k) %BASE
