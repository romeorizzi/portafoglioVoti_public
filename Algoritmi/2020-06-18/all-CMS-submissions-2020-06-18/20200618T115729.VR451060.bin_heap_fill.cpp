...
* task:  bin_heap_fill
* score: 25.0
* date:  2020-06-18 11:57:29.507077
*/
#include <iostream>
#include <vector>
...
vector<int> Friecom(vector<int> A,vector<int> f){
    vector<int> daCreare;
...
int main(){
    ...
    cin>>g;
    cin>>problemaScelto;
    int valoreInteressato;
    for(int index=0;index<g;index++){
        cin>>valoreInteressato;
        A.push_back(valoreInteressato);
    }

    for(int index=0;index<g;index++){
        cin>>valoreInteressato;
        e.push_back(valoreInteressato);
    }

    for(int index=0;index<g;index++){
        cin>>valoreInteressato;
        f.push_back(valoreInteressato);
    }
