...
* task:  tree_transcode
* score: 0.0
* date:  2019-06-25 09:47:00.249034
*/
#include <assert.h>
#include <stdio.h>
#include <string.h>
...
int main(){
    ...
    if(codice_albero == 1){
        ...
        vector<int> myvector_valore_nodo;
        ...
        while (!myvector_valore_nodo.empty()){
            ...
            // abbasso il valore del padre
            myvector_valore_nodo.back() -= nodo_locale;
            //printf("Ho abbassato il valore del padre a %d.\n",myvector_valore_nodo.back());
            // Se il numero è un 1, posso mettere nell'array due volte il suo grado e andare oltre.
            if(nodo_locale == 1){
        ...
        /*
        for (int counter = 0; counter < (nodo_radice - 1); counter++ ){
            int nodo_locale;
            scanf("%d",&nodo_locale);
            printf("%d ",nodo_locale);
        ...
        */
        ...
        // E se qua sopra usassi invece un vettore?
        // Così posso fare una push_back, ma non mi pare serva a granché.
        // Inoltre potrei analizzare e far passare avanti qualcosa???
        // Però la dimensione dell'array la so già all'inizio alla fin fine
        // Potrei creare un vettore con gli interi dei nodi fino ad adesso.
        // usarlo in pratica come uno stack, per vedere qual è l'ultimo grado
        // e nel caso 
