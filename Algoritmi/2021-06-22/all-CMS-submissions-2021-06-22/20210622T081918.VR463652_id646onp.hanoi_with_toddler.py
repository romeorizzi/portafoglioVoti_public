...
* score: 10.0
* date:  2021-06-22 08:19:18.682526
"""
#!/usr/bin/env python3
# -*- coding: latin-1 -*-
...
def sposta_disco(i, peg_from, peg_to):
    ...
    DEPTH = DEPTH + 1
    if DEPTH % 2 != 0:
        print(f"daddy sposta il disco {i} dal peg {peg_from} al peg {peg_to}")
    else:
        print(f"toddler sposta il disco {i} dal peg {peg_from} al peg {peg_to}")
    curr_peg[i] = peg_to
