...
* score: 0.0
* date:  2019-09-04 12:24:23.542637
*/
#include <cstdio>
#include <iostream>
#include <vector>
...
int main(){
    ...
    while(vettore_dischi_b1.size()<size){
        ...
        if(vettore_dischi_a1.size()!=0 && vettore_dischi_b1.size()==0 && vettore_dischi_c1.size()==0){
            sposta('A', 'B');
        }
        if(vettore_dischi_a1.size()>1 && vettore_dischi_b1.size()>0 &&   vettore_dischi_c1.size()==0){
            sposta('A','C');
        }
        if(vettore_dischi_a1.size()==0 && vettore_dischi_b1.size()>0 && vettore_dischi_c1.size()>1){
            sposta('C','A');
        }
        if(vettore_dischi_a1.size()==1 && vettore_dischi_c1.size()==0){
            sposta('A','B');
        }
