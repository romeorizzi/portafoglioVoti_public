...
* score: 0.0
* date:  2019-09-04 11:40:51.958362
*/
#include <cstdio>
#include <iostream>
#include <vector>
...
void sposta(char da, char a){
    if (da=='A' && a=='B'){
        ...
        vettore_dischi_b1.insert(vettore_dischi_a1.begin());
        vettore_dischi_b2.insert(vettore_dischi_a2.begin());
        ...
        vettore_dischi_c1.insert(vettore_dischi_b1.begin());
        vettore_dischi_c2.insert(vettore_dischi_b2.begin());
        ...
        vettore_mosse.push_back('A');
        vettore_mosse.push_back('C');
        vettore_dischi_c1.insert(vettore_dischi_a1.begin());
        vettore_dischi_c2.insert(vettore_dischi_a2.begin());
        vettore_dischi_a1.erase(vettore_dischi_a1.begin());
        vettore_dischi_a2.erase(vettore_dischi_a2.begin());
        conteggio++;
    }
        ...
        vettore_mosse.push_back('C');
        vettore_mosse.push_back('B');
        vettore_dischi_b1.insert(vettore_dischi_c1.begin());
        vettore_dischi_b2.insert(vettore_dischi_c2.begin());
        ...
        vettore_mosse.push_back('C');
        vettore_mosse.push_back('A');
        vettore_dischi_a1.insert(vettore_dischi_c1.begin());
        vettore_dischi_a2.insert(vettore_dischi_c2.begin());
        vettore_dischi_c1.erase(vettore_dischi_c1.begin());
        vettore_dischi_c2.erase(vettore_dischi_c2.begin());
        conteggio++;
    }
