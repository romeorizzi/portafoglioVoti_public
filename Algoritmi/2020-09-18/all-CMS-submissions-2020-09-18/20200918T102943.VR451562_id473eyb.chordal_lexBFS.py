...
* task:  chordal_lexBFS
* score: 10.0
* date:  2020-09-18 10:29:43.304842
"""
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
def task3(graph, n):
    ...
    for k in range(k, 0, -1): # run the elim order reversed
        clq = set() # each clique is a set so we can do intersections op
        clq = set(graph._graph[k]) & leftneigh # intersection with later vertexes and neighbors = later neighbors
        clq.add(k)
        leftneigh.add(k)
